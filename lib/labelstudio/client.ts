...
<View>
  <Header value="Play #$playNumber - Navigate to $startTime to $endTime seconds"/>
  <View style="background: #fef3c7; padding: 8px; border-radius: 4px; margin-bottom: 10px;">
    <Text name="timeHint" value="Seek video to timestamp shown above before labeling"/>
  </View>
  <Video name="video" value="$video" framerate="30.0"/>
  <VideoRectangle name="box" toName="video" />
  <Labels name="playerLabels" toName="video" allowEmpty="true">
