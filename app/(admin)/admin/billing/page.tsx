  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Monitor subscription revenue and manage team billing</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400">Monthly Churn Rate</div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Team Subscriptions</h2>
              ...
              {filteredSubscriptions.map((sub) => (
                <tr key={sub.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                  <td className="py-4 px-6">
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">{sub.teamName}</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">{sub.memberCount} members</div>
                    </div>
                  </td>
                  <td className="py-4 px-6">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#0f2d52]/10 dark:bg-blue-900/30 text-[#0f2d52] dark:text-blue-400">
                      {sub.planName}
                    </span>
                  </td>
                  <td className="py-4 px-6">
                  ...
                  <td className="py-4 px-6 text-gray-900 dark:text-white">${sub.amount}/mo</td>
                  <td className="py-4 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            {[
              { plan: 'Team', amount: 2990, count: 10, color: 'bg-[#0f2d52] dark:bg-blue-500' },
              { plan: 'Pro', amount: 1490, count: 10, color: 'bg-blue-500' },
              { plan: 'Starter', amount: 1078, count: 22, color: 'bg-green-500' },
            ].map((item) => (
              <div key={item.plan}>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{item.plan}</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              >
                <div>
                  <div className="text-sm font-medium text-gray-900 dark:text-white">{tx.team}</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">{tx.date}</div>
                </div>
                <div className="text-right">
                  <div
                    className={`text-sm font-medium ${
                      tx.type === 'failed' ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'
                    }`}
                  >
