      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-md transition-shadow cursor-pointer">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-lg bg-[#0f2d52]/10 flex items-center justify-center">
  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Game Film</h1>
          <p className="text-gray-500 mt-1">Upload and analyze your game footage</p>
        </div>
        <Link href="/games/new">
